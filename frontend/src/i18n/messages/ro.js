...
const ro = {
  ...
  serverErrors: {
    ...
    passwordNumeric: "Această parolă are doar cifre.",
    passwordSimilar: "Parola seamănă prea mult cu numele de utilizator.",
    passwordTooShort: "Această parolă este prea scurtă. Trebuie să aibă cel puțin {min} caractere.",
    invalidEmail: "Introdu o adresă de email validă.",
    tooLong: "Acest câmp nu poate avea mai mult de {max} caractere.",
    invalidChoice: "\"{value}\" nu este o opțiune validă.",
    usernameTaken: "Există deja un utilizator cu acest nume.",
    invalidCredentials: "Nume de utilizator sau parolă greșite.",
    wrongCurrentPassword: "Parola actuală este greșită.",
    wrongPassword: "Parolă greșită.",
    passwordsDontMatch: "Parolele nu se potrivesc.",
    resetLinkInvalid: "Acest link de resetare a parolei nu este valid sau a expirat. Solicită unul nou.",
    choosePathway: "Alege un parcurs valid.",
    nameCharacters: "Folosește doar litere, spații, cratime sau apostrofuri.",
    writeAnswer: "Scrie mai întâi un răspuns.",
    questionTooShort: "Scrie întrebarea puțin mai lung, ca oamenii să înțeleagă ce vrei să spui.",
    deleteOwn: "Poți șterge doar întrebările tale.",
    awaitingReview: "Această întrebare așteaptă verificarea echipei.",
    onlyAsker: "Doar cel care a întrebat poate marca răspunsul care l-a ajutat.",
    typeQuestion: "Scrie mai întâi o întrebare.",
    enterPostcode: "Introdu un cod poștal.",
    postcodeServiceDown: "Serviciul de căutare a codurilor poștale nu este disponibil acum. Încearcă din nou în curând.",
    postcodeNotFound: "Nu am găsit codul poștal \"{postcode}\". Verifică-l și încearcă din nou.",
    chooseDistance: "Alege o distanță între 1 și {max} mile.",
    unknownPathway: "Parcurs necunoscut: \"{pathway}\".",
    chooseOneOf: "Alege una dintre: {choices}.",
  },
  ...
  staff: {
    title: "Trimiteri de interes",
    lead: "Toți cei care și-au înregistrat interesul, de la cei mai noi. Sunt datele de contact ale unor oameni reali, așa că tratează-le cu grijă.",
    loadError: "Trimiterile nu s-au putut încărca. Reîncarcă pagina ca să încerci din nou.",
    loading: "Se încarcă trimiterile.",
    empty: "Încă nu există trimiteri.",
    count: "{count} trimiteri, {shown} pe această pagină.",
    countOne: "{count} trimitere, {shown} pe această pagină.",
    caption: "Trimiteri de interes, de la cele mai noi",
    columns: {
      name: "Nume",
      email: "Email",
      type: "Tip",
