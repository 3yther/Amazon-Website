...
const ro = {
  ...
  nearYou: {
    ...
    type: "Tip",
    foundationYear: "An pregătitor",
    groupNear: "Școli în apropiere",
    groupOffering: "Oferă {pathway}",
    unconfirmedTitle: "Materii neconfirmate",
    unconfirmedNote: "Registrul oficial arată că aceste școli oferă T-Levels, dar nu și care anume. Sunt în apropiere, deci întreabă dacă oferă {pathway}.",
    unconfirmedNoteOne: "Registrul oficial arată că această școală oferă T-Levels, dar nu și care anume. Este în apropiere, deci întreabă dacă oferă {pathway}.",
    notConfirmed: "Neconfirmat, întreabă școala",
    noneOfFive: "Niciunul dintre cele cinci trasee ale noastre",
    oneFoundOffering: "1 școală care oferă {pathway} pe o rază de {radius} mile de {postcode}.",
    foundOffering: "{count} școli care oferă {pathway} pe o rază de {radius} mile de {postcode}.",
    noneConfirmed: "Nicio școală confirmată cu {pathway} pe o rază de {radius} mile de {postcode}.",
    oneUnsure: "1 școală din apropiere nu are materiile confirmate.",
    unsure: "{count} școli din apropiere nu au materiile confirmate.",
    errors: {
