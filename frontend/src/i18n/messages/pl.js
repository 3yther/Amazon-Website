...
const pl = {
  ...
  serverErrors: {
    ...
    passwordNumeric: "To hasło składa się tylko z cyfr.",
    passwordSimilar: "Hasło jest zbyt podobne do nazwy użytkownika.",
    passwordTooShort: "To hasło jest za krótkie. Musi mieć co najmniej {min} znaków.",
    invalidEmail: "Wpisz prawidłowy adres e-mail.",
    tooLong: "To pole może mieć najwyżej {max} znaków.",
    invalidChoice: "\"{value}\" nie jest prawidłowym wyborem.",
    usernameTaken: "Użytkownik o tej nazwie już istnieje.",
    ...
    resetLinkInvalid: "Ten link do resetowania hasła jest nieprawidłowy lub wygasł. Poproś o nowy.",
    choosePathway: "Wybierz prawidłową ścieżkę.",
    nameCharacters: "Używaj tylko liter, spacji, łączników lub apostrofów.",
    writeAnswer: "Najpierw napisz odpowiedź.",
    questionTooShort: "Napisz pytanie trochę dłużej, żeby było jasne, o co ci chodzi.",
    deleteOwn: "Możesz usuwać tylko własne pytania.",
    awaitingReview: "To pytanie czeka na sprawdzenie przez zespół.",
    onlyAsker: "Tylko osoba, która zadała pytanie, może oznaczyć odpowiedź, która pomogła.",
    typeQuestion: "Najpierw wpisz pytanie.",
    enterPostcode: "Wpisz kod pocztowy.",
    postcodeServiceDown: "Wyszukiwarka kodów pocztowych jest teraz niedostępna. Spróbuj ponownie za chwilę.",
    postcodeNotFound: "Nie znaleźliśmy kodu pocztowego \"{postcode}\". Sprawdź go i spróbuj ponownie.",
    chooseDistance: "Wybierz odległość od 1 do {max} mil.",
    unknownPathway: "Nieznana ścieżka: \"{pathway}\".",
    chooseOneOf: "Wybierz jedną z opcji: {choices}.",
  },
  ...
  staff: {
    title: "Zgłoszenia zainteresowania",
    lead: "Wszyscy, którzy zgłosili zainteresowanie, od najnowszych. To dane kontaktowe prawdziwych osób, więc traktuj je z rozwagą.",
    loadError: "Nie udało się wczytać zgłoszeń. Odśwież stronę, aby spróbować ponownie.",
    loading: "Wczytywanie zgłoszeń.",
    empty: "Nie ma jeszcze zgłoszeń.",
    count: "Zgłoszenia: {count}, na tej stronie: {shown}.",
    countOne: "Zgłoszenia: {count}, na tej stronie: {shown}.",
    caption: "Zgłoszenia zainteresowania, od najnowszych",
    columns: {
